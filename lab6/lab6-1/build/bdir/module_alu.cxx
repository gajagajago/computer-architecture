...
tUInt32 MOD_module_alu::METH_alu(tUInt32 ARG_alu_a, tUInt32 ARG_alu_b, tUInt8 ARG_alu_func)
{
  ...
  tUInt32 DEF_alu_a_SRA_alu_b_BITS_4_TO_0_8___d22;
  ...
  DEF_alu_a_SRA_alu_b_BITS_4_TO_0_8___d22 = primShiftRA32(32u,
							  32u,
							  (tUInt32)(ARG_alu_a),
							  5u,
							  (tUInt8)(DEF_c__h194));
  ...
  case (tUInt8)9u:
    ...
    break;
  default:
    PORT_alu = DEF_alu_a_SRA_alu_b_BITS_4_TO_0_8___d22;
  }
  return PORT_alu;
}
