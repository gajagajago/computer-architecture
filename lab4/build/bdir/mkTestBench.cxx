...
static std::string const __str_literal_7("Program Exceeded the maximum cycle %d\n", 38u);
...
void MOD_mkTestBench::RL_halt()
{
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_fwrite(sim_hdl, this, "32,s,-32", 2147483650u, &__str_literal_7, DEF_signed_300000___d22);
    dollar_finish(sim_hdl, "32", 1u);
  }
}
