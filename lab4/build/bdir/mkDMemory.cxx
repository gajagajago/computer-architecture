...
/* String declarations */
static std::string const __str_literal_1("mmemory.vmh", 11u);
...
void MOD_mkDMemory::init_symbols_0()
{
  ...
  init_symbol(&symbols[3u], "memInit_initialized__h383", SYM_DEF, &DEF_memInit_initialized__h383, 1u);
...
tUInt32 MOD_mkDMemory::METH_req(tUWide ARG_req_r)
{
  ...
  tUInt32 DEF_index__h256;
  tUInt32 DEF_x__h304;
  tUInt32 PORT_req;
  PORT_req_r = ARG_req_r;
  DEF_x__h304 = ARG_req_r.get_whole_word(0u);
  DEF_index__h256 = ARG_req_r.get_bits_in_word32(1u, 2u, 16u);
  DEF_req_r_BIT_64___d1 = ARG_req_r.get_bits_in_word8(2u, 0u, 1u);
  DEF_req__avValue1 = INST_mem.METH_sub(DEF_index__h256);
  PORT_req = DEF_req__avValue1;
  if (DEF_req_r_BIT_64___d1)
    INST_mem.METH_upd(DEF_index__h256, DEF_x__h304);
  return PORT_req;
}
...
{
  tUInt8 DEF_init_request_put_BIT_64___d4;
  PORT_init_request_put = ARG_init_request_put;
  DEF_init_request_put_BIT_64___d4 = ARG_init_request_put.get_bits_in_word8(2u, 0u, 1u);
  if (DEF_init_request_put_BIT_64___d4)
...
tUInt8 MOD_mkDMemory::METH_RDY_init_request_put()
{
  ...
  DEF_memInit_initialized__h383 = INST_memInit_initialized.METH_read();
  DEF_CAN_FIRE_init_request_put = !DEF_memInit_initialized__h383;
...
tUInt8 MOD_mkDMemory::METH_init_done()
{
  ...
  DEF_memInit_initialized__h383 = INST_memInit_initialized.METH_read();
  PORT_init_done = DEF_memInit_initialized__h383;
...
unsigned int MOD_mkDMemory::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "memInit_initialized__h383", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkDMemory::vcd_defs(tVCDDumpType dt, MOD_mkDMemory &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_memInit_initialized__h383) != DEF_memInit_initialized__h383)
      {
	vcd_write_val(sim_hdl, num, DEF_memInit_initialized__h383, 1u);
	backing.DEF_memInit_initialized__h383 = DEF_memInit_initialized__h383;
      }
      ++num;
