...
static std::string const __str_literal_4("Executed Instructions : %d\n", 27u);
static std::string const __str_literal_3("Number of Cycles      : %d\n", 27u);
static std::string const __str_literal_5("Program Exceeded the maximum cycle %d\n", 38u);
...
void MOD_mkTestBench::RL_countCycle()
{
  ...
  DEF_x__h254 = DEF__read__h122 + 1u;
  if (DEF_cycle_EQ_300000___d7)
    INST_tState.METH_write((tUInt8)2u);
  if (DEF_NOT_cycle_EQ_300000___d8)
    INST_cycle.METH_write(DEF_x__h254);
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_NOT_cycle_EQ_300000___d8)
      dollar_display(sim_hdl, this, "s,32", &__str_literal_1, DEF__read__h122);
}
...
void MOD_mkTestBench::RL_run()
{
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_3, DEF__read__h122);
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
...
{
  tUInt32 DEF_signed_300000___d17;
  DEF_signed_300000___d17 = 300000u;
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_fwrite(sim_hdl, this, "32,s,-32", 2147483650u, &__str_literal_5, DEF_signed_300000___d17);
    dollar_finish(sim_hdl, "32", 1u);
  }
}
